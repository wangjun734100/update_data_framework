...
mylog = Logger(logger="Test_get_Group_conut").getlog()




class Test_get_Group_conut(unittest.TestCase):
    '''接口名称:获取组统计'''
    ...
    def test_get_groeps_count(self):
        ...
        self.url=browser+"/api/app/group/groupcount"
