...
class Test_client_Create(unittest.TestCase):
    '''接口名称:create client'''
    ...
    def test_client_create(self):
        ...
        self.url=browser+"/api/app/client/create"
        ...
        for i in range(0, row - 1):
            if status[i] == '执行':
                ...
                clientid = response.json()["data"]["clientid"]
                return clientid
