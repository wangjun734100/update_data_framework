...
mylog = Logger(logger="Test_client_count").getlog()



class Test_client_count(unittest.TestCase):
    '''接口名称:get clent count'''
    ...
    def test_client_counts(self):
        ...
        # clentid=Test_client_Create().test_client_create()
        config = readConfigFile.ReadConfig()
        browser = config.get_http("browserName")
        excel = ReadExcel("client_count")
        ...
        self.url=browser+"/api/app/group/clientcount"
